unit mamutti.view.components.cardsgraficos;
...
uses
  ...
  FMX.Layouts,
  FMX.Objects,
  FMX.Controls.Presentation, mamutti.services.enums;
...
type
  ...
  public
    ...
    function DescricaoRodape(Value: String; Color: TAlphaColor = $FF6BD098): TComponentCardGraficos;
...
uses mamutti.services.utils, mamutti.services.charts;
