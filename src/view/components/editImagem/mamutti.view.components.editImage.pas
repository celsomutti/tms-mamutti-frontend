unit mamutti.view.components.editImage;
...
uses
  ...
  FMX.Edit, mamutti.view.components.interfaces;
...
function TComponentEditImage.BackgroundColot(VAlue: TAlphaColor): iEdits;
begin
  Result := Self;
